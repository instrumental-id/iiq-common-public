...
import com.identityworksllc.iiq.common.minimal.TaskCallback;
import com.identityworksllc.iiq.common.minimal.Utilities;
import com.identityworksllc.iiq.common.minimal.vo.Outcome;
...
public abstract class SailPointWorker implements Runnable, Serializable {
	...
	/**
	 * The attribute used to pass this object in serialized form to {@link com.identityworksllc.iiq.common.minimal.request.SailPointWorkerExecutor}.
	 */
	...
	/**
	 * Serializes a list of SailPointWorker object into a Request suitable for use with {@link com.identityworksllc.iiq.common.minimal.request.SailPointWorkerExecutor}. That executor must be associated with the provided RequestDefinition.
	 * @param requestDefinition The request definition associated with {@link com.identityworksllc.iiq.common.minimal.request.SailPointWorkerExecutor}
	...
	/**
	 * Serializes this SailPointWorker object into a Request suitable for use with {@link com.identityworksllc.iiq.common.minimal.request.SailPointWorkerExecutor}. That executor must be associated with the provided RequestDefinition.
	 * @param requestDefinition The request definition associated with {@link com.identityworksllc.iiq.common.minimal.request.SailPointWorkerExecutor}
	 * @return The Request containing a serialized object
	 * @throws GeneralException if any failures occur compressing the object
	 * @throws IOException if any failures occur serializing this {@link SailPointWorker}
